...
library(dplyr)
```
Here, we mostly use functions from base R to organize our data. However, we load the `dplyr` package, a toolkit for splitting, applying and combining data. For more advanced and faster functions related to data manipulation, have a look at the documentation of the packages `dplyr`, `reshape2`, `data.table` etc.  
&nbsp;
