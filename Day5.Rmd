...
```{r, echo=TRUE}
grid <- readOGR("data/30min_grid_select50/30min_grid_select50%.shp", integer64="allow.loss") # read in polygon shapefile
...
par(mfrow=c(1,3))
hist(grid@data$temp, main="", xlab="Annual mean temperature (C°)")
hist(grid@data$prec, main="", xlab="Mean annual precipitation (mm)")
hist(grid@data$elev, main="", xlab="Elevation a.s.l. (m)")
