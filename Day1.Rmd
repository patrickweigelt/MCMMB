...
## 5. Loading and visualising environmental data

**Download the following raster layers and extract them to your R-project folder (.Rproj)**  
...
**Exercise: Open QGIS and add the raster layers to your project in QGIS**
&nbsp;
