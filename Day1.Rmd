...
* Create a project for the class in RStudio and remember the project folder

* Create a new R script for Day 1 and save it
...
**Download the following raster layers and extract them to your R-project folder ../data/**  
...
```
```{r, echo=FALSE}
rasterOptions(tmpdir="D:/rastertemp/") # raster saves large temporary files in your user operating systems` user folder. You might want to change this if you're running out of disk space
```
&nbsp;
