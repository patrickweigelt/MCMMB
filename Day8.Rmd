...
dim(grid_coverage_height); head(grid_coverage_height)
...
# PCA plot
# Individual coordinates with categories (same order than in original data)
...
We here focus on functional richness which is the volume of functional space occupied by a community convex hull that encompasses all points.  
