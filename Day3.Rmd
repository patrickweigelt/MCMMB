...
par(mfrow = c(2, 2))
plot(st_geometry(grid),
     col = ifelse(grid$Geonoma.pauciflora == 1, "#ef8a62", "#7fbf7b"), 
...
#species 2
plot(st_geometry(grid),
     col=ifelse(grid$Geonoma.undata==1,"#ef8a62", "#7fbf7b"), 
...
#species 3
plot(st_geometry(grid),
     col=ifelse(grid$Phytelephas.tenuicaulis==1,"#ef8a62","#7fbf7b"), 
...
#species 4
plot(st_geometry(grid),
     col=ifelse(grid$Mauritia.flexuosa==1,"#ef8a62","#7fbf7b"), 
...
plot(st_geometry(geo_pau_abs),
     col = ifelse(geo_pau_abs$present == 1, "#ef8a62", "#7fbf7b"), 
...
plot(st_geometry(geo_und_abs),
     col=ifelse(geo_und_abs$present == 1,"#ef8a62", "#7fbf7b"), 
...
plot(st_geometry(phy_ten_abs),
     col=ifelse(phy_ten_abs$present==1, "#ef8a62", "#7fbf7b"), 
...
plot(st_geometry(mau_fle_abs),
     col = ifelse(mau_fle_abs$present == 1,"#ef8a62", "#7fbf7b"), 
...
elev <- rast("data/mn30_grd/mn30_grd/") + 0 # +0 to treat raster as numeric
