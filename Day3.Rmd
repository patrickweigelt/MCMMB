...
par(mfrow=c(2,2))
  ...
  plot(st_geometry(grid), col=ifelse(grid$Geonoma.pauciflora==1,"#ef8a62","#7fbf7b"), 
...
#species 2
plot(st_geometry(grid), col=ifelse(grid$Geonoma.undata==1,"#ef8a62","#7fbf7b"), 
...
#species 3
plot(st_geometry(grid), col=ifelse(grid$Phytelephas.tenuicaulis==1,"#ef8a62","#7fbf7b"), 
...
#species 4
plot(st_geometry(grid), col=ifelse(grid$Mauritia.flexuosa==1,"#ef8a62","#7fbf7b"), 
...
geo_pau = st_as_sf(spec_occ[which(spec_occ$scrubbed_species_binomial == "Geonoma pauciflora"),
...
geo_pau_abs <- rbind(grid_centroids[sample(nrow(grid_centroids),
                                           nrow(geo_pau), replace = TRUE),"present"],
                     geo_pau)

par(mfrow=c(2,2))

plot(st_geometry(geo_pau_abs), col=ifelse(geo_pau_abs$present==1,"#ef8a62","#7fbf7b"), 
     main="Geonoma pauciflora", pch = 3)
plot(st_geometry(americas), add=TRUE)

# Geonoma undata
geo_und = st_as_sf(spec_occ[which(spec_occ$scrubbed_species_binomial == "Geonoma undata"),
                            c("longitude","latitude")], 
                   coords = c("longitude", "latitude"), 
                   crs = "+proj=longlat +ellps=WGS84 +no_defs")
geo_und$present = 1
...
# add pseudo-absences
set.seed(100)
geo_und_abs <- rbind(grid_centroids[sample(nrow(grid_centroids),
                                           nrow(geo_und), replace = TRUE),"present"],
                     geo_und)

plot(st_geometry(geo_und_abs), col=ifelse(geo_und_abs$present==1,"#ef8a62","#7fbf7b"), 
     main="Geonoma undata", pch = 3)
plot(st_geometry(americas), add=TRUE)

# Phytelephas tenuicaulis
phy_ten = st_as_sf(spec_occ[which(spec_occ$scrubbed_species_binomial == "Phytelephas tenuicaulis"),
                            c("longitude","latitude")], 
                   coords = c("longitude", "latitude"), 
                   crs = "+proj=longlat +ellps=WGS84 +no_defs")
phy_ten$present = 1
...
# add pseudo-absences
set.seed(100)
phy_ten_abs <- rbind(grid_centroids[sample(nrow(grid_centroids),
                                           nrow(phy_ten), replace = TRUE),"present"],
                     phy_ten)

plot(st_geometry(phy_ten_abs), col=ifelse(phy_ten_abs$present==1,"#ef8a62","#7fbf7b"), 
     main="Phytelephas tenuicaulis", pch = 3)
plot(st_geometry(americas), add=TRUE)


# Mauritia flexuosa
mau_fle = st_as_sf(spec_occ[which(spec_occ$scrubbed_species_binomial == "Mauritia flexuosa"),
                            c("longitude","latitude")], 
                   coords = c("longitude", "latitude"), 
                   crs = "+proj=longlat +ellps=WGS84 +no_defs")
mau_fle$present = 1
...
# add pseudo-absences
set.seed(100)
mau_fle_abs <- rbind(grid_centroids[sample(nrow(grid_centroids),
                                           nrow(mau_fle), replace = TRUE),"present"],
                     mau_fle)

plot(st_geometry(mau_fle_abs), col=ifelse(mau_fle_abs$present==1,"#ef8a62","#7fbf7b"), 
...
plot(st_geometry(grid), col=ifelse(grid$Geonoma.pauciflora==1,"#7fbf7b","white"), 
     border=FALSE, main = "Geonoma pauciflora")
...
plot(st_geometry(grid), col=ifelse(grid$Geonoma.undata==1,"#7fbf7b","white"),
     border=FALSE, main = "Geonoma undata")
plot(st_geometry(americas),add=TRUE)
...
plot(st_geometry(grid), col=ifelse(grid$Phytelephas.tenuicaulis==1,"#7fbf7b","white"), 
     border=FALSE, main = "Phytelephas tenuicaulis")
...
plot(st_geometry(grid), col=ifelse(grid$Mauritia.flexuosa==1,"#7fbf7b","white"), 
     border=FALSE, main = "Mauritia flexuosa")
