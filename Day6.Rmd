...
To combine the islands data.frame with the world map, we first need to convert it as a *sf* object.

```{r}
# Convert islands as a sf object
...
## 1.2. Correlations among biogeographic \& environmental variables
